...
export class AppComponent implements OnInit, AfterViewInit  {
    ...
    this.camera = new THREE.PerspectiveCamera(30, 450 / 220, 800, 10000);
    ...
    ngAfterViewInit() {
        ...
        this.mesh2.position.set(400, 0, 0); // 좌우 넓이 조절
